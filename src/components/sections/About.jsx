...
const education = [
    {
        ...
        description: "Comprehensive program covering software development, system analysis, database management, network infrastructure, and modern programming paradigms.",
    ...
    },
    {
        ...
        location: "Maputo, Mozambique",
        description: "Technical diploma focused on computer systems, hardware maintenance, software installation, network configuration, and IT support fundamentals.",
                ...
                <FadeIn delay={200}>
                    <div className='flex flex-col gap-5'>
                        <div className='flex items-center gap-2.5 mb-2'>
                            ...
                            <h3 className='text-base font-medium text-white/60 uppercase tracking-widest'>Education</h3>
                        </div>
